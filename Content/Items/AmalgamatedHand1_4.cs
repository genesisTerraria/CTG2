...
namespace CTG2.Content.Items {
	...
	public class AmalgamatedHand1_4 : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<AmalgamatedHandProjectile1_4>();
		}

	}

	public class AmalgamatedHandProjectile1_4 : ModProjectile
	{
