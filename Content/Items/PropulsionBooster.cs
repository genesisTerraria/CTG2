...
namespace CTG2.Content.Items
{
	...
	public class PropulsionBooster : ModItem
	{
		...
		public override void UpdateAccessory(Player player, bool hideVisual) {
			player.GetModPlayer<PropulsionBoosterPlayer>().DashAccessoryEquipped = true;
		}
	}

	public class PropulsionBoosterPlayer : ModPlayer
	{
		...
		public float DashVelocity = 18f; // The initial velocity.  10 velocity is about 37.5 tiles/second or 50 mph
		...
		public override void PreUpdateMovement()
		{
			...
			{
				float flightTimeRemaining = ModContent.GetInstance<PlanetaryExplorationGearPlayer>().flightTimeRemaining;
