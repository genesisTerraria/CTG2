...
//     private bool Released        => SlashTimer >= 0f;
...
//             else
//             {
//                 // Player released – begin slash
//                 if (Projectile.owner == Main.myPlayer)
//                 {
//                     SlashTimer = 0f;
//                     LockedDir  = player.direction; // lock direction
//                     Projectile.netUpdate = true;
//                 }
//             }
//         }
...
//     {
//         if (!Released)
//             return -MathHelper.PiOver2; // straight up
...
//             tint,
//             drawRotation,
//             tex.Size() * 0.5f,  // origin = center of sprite
//             1f,
//             SpriteEffects.None,
//             0
//         );
