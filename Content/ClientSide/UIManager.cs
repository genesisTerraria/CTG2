...
{   
    ...
    private void DrawAbilityCooldown()
    {
        ...
        else if (selectedClass == 10)
        {
            ...
            Texture2D Ability1Icon = ModContent.Request<Texture2D>("CTG2/Content/Classes/MinerAbilityIcons/MinerAbility1").Value;
            Texture2D Ability2Icon = ModContent.Request<Texture2D>("CTG2/Content/Classes/MinerAbilityIcons/MinerAbility2").Value;
